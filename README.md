...
- [Пример работы функций в модулях `utils` и `external_api`:](#пример-работы-функций-в-модулях-utils-и-external_api)
...
Проект "homework_12_1" является продолжением работы над виджетом банковских операций клиента, 
функционал которого уже частично реализован в предыдущих проектах: 
`homework_9_1`, `homework_9_2`, `homework_10_1`, `homework_10_2`, `homework_11_1`, `homework_11_2`. 
...
## Пример работы функций в модулях `utils` и `external_api`:
...
валют и конвертации суммы операции в рубли. Для конвертации валюты применяется `Exchange Rates Data API`:
